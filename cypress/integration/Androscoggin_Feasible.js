...
describe('filesuploading', ()=>
{
    ...
    it('entering schdule name' ,()=> {
        ...
        cy.get('input[type="text"]').type("Androscoggin_Feasible_".concat(date))
        cy.get('input[type="text"]').type('{enter}')
        cy.wait(2000)
        const networkFile= 'Androscoggin_Feasible/NetworkDescription.xlsx'
        const efficienceyFile= 'Androscoggin_Feasible/GeneratorEfficiency.xlsx'
        const conversionFile= 'Androscoggin_Feasible/StorageConversion.xlsx'
        ...
        cy.get('a[download^="aom_Androscoggin_Feasible_"]').click()

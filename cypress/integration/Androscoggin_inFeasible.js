...
describe('filesuploading', ()=>
{
    ...
    it('entering schdule name' ,()=> {
        ...
        cy.get('input[type="text"]').type("Androscoggin_inFeasible_".concat(date))
        cy.get('input[type="text"]').type('{enter}')
        cy.wait(2000)
        const networkFile= 'Androscoggin_inFeasible/NetworkDescription.xlsx'
        const efficienceyFile= 'Androscoggin_inFeasible/GeneratorEfficiency.xlsx'
        const conversionFile= 'Androscoggin_inFeasible/StorageConversion.xlsx'
        ...
        cy.get('a[download^="aom_Androscoggin_inFeasible"]').click()

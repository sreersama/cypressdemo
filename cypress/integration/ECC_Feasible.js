...
describe('filesuploading', ()=>
{
    ...
    it('entering schdule name' ,()=> {
        ...
        cy.get('input[type="text"]').type("ECC_Feasible_".concat(date))
        cy.get('input[type="text"]').type('{enter}')
        cy.wait(2000)
        const networkFile= 'ECC_Feasible/NetworkDescription.xlsx'
        const efficienceyFile= 'ECC_Feasible/GeneratorEfficiency.xlsx'
        const conversionFile= 'ECC_Feasible/StorageConversion.xlsx'
        ...
        cy.get('a[download^="aom_ECC_Feasible_"]').click()

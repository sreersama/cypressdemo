...
describe('filesuploading', ()=>
{
    ...
    it('entering schdule name' ,()=> {
        ...
        cy.get('input[type="text"]').type("ECC_inFeasible_".concat(date))
        cy.get('input[type="text"]').type('{enter}')
        cy.wait(2000)
        const networkFile= 'ECC_inFeasible/NetworkDescription.xlsx'
        const efficienceyFile= 'ECC_inFeasible/GeneratorEfficiency.xlsx'
        const conversionFile= 'ECC_inFeasible/StorageConversion.xlsx'
        ...
        cy.get('a[download^="aom_ECC_inFeasible"]').click()

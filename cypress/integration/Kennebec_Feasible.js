...
describe('filesuploading', ()=>
{
    ...
    it('entering schdule name' ,()=> {
        ...
        cy.get('input[type="text"]').type("Kennebec_Feasible_".concat(date))
        cy.get('input[type="text"]').type('{enter}')
        cy.wait(2000)
        const networkFile= 'Kennebec_Feasible/NetworkDescription.xlsx'
        const efficienceyFile= 'Kennebec_Feasible/GeneratorEfficiency.xlsx'
        const conversionFile= 'Kennebec_Feasible/StorageConversion.xlsx'
        ...
        cy.get('a[download^="aom_Kennebec_Feasible_"]').click()

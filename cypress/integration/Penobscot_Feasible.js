...
describe('filesuploading', ()=>
{
    ...
    it('entering schdule name' ,()=> {
        ...
        cy.wait(2000)
        const networkFile= 'Penobscot_Feasible/NetworkDescription.xlsx'
        const efficienceyFile= 'Penobscot_Feasible/GeneratorEfficiency.xlsx'
        const conversionFile= 'Penobscot_Feasible/StorageConversion.xlsx'
        ...
        cy.get('a[download^="aom_PenobscotFeasible_"]').click()

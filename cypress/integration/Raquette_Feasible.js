...
describe('filesuploading', ()=>
{
    ...
    it('entering schdule name' ,()=> {
        ...
        cy.get('input[type="text"]').type("RaquetteFeasible_".concat(date))
        cy.get('input[type="text"]').type('{enter}')
        cy.wait(2000)
        const networkFile= 'Raquette_Feasible/NetworkDescription.xlsx'
        const efficienceyFile= 'Raquette_Feasible/GeneratorEfficiency.xlsx'
        const conversionFile= 'Raquette_Feasible/StorageConversion.xlsx'
        ...
        cy.get('a[download^="aom_RaquetteFeasible_"]').click()
